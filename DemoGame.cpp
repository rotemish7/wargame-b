...
namespace WarGame {
		...
		uint DemoGame::play() {
			board.move(2, {7,0}, Board::MoveDIR::Right);    // FootSoldier of player 2 moves forward and attacks from {7,1} to {6,1}.
			...
			std::cout << "3------------" << std::endl;
			board.print();   // FootSoldier of player 1 moves forward and attacks from {0,1} to {1,1}.
			if (!board.has_soldiers(2)) return 1;
